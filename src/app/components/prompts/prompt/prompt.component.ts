...
export class PromptComponent {
    ...
    constructor(
        private chatgptExtService: ChatgptExtService,
    ...
    ngOnInit(): void {
        ...
        this.answerSub$ = this.chatgptExtService
            .getExtChatgptAnswer()
            .subscribe((result) => {
    ...
    onCheckAnswer() {
        const prompt = this.promptService.genGrammarPrompt({
            grammar: this.grammar.name,
            scope: this.grammar.scope,
            anwser: this.answer,
        });
    ...
    onGetExample() {
        const prompt = this.promptService.genGrammarxamplePrompt({
            grammar: this.grammar.name,
            scope: this.grammar.scope,
        });
        this.chatgptExtService.checkAnswer(prompt);
